...
class Empresa(db.Model):
    ...
    movimentacoes_materiais = db.relationship(
...
class Usuario(UserMixin, db.Model):
    ...
    recebimentos_materiais = db.relationship(
        "MovimentacaoMaterial",
        back_populates="recebido_por",
        foreign_keys="MovimentacaoMaterial.recebido_por_id",
        lazy=True,
    )

    cancelamentos_materiais = db.relationship(
        "MovimentacaoMaterial",
        back_populates="cancelado_por",
        foreign_keys="MovimentacaoMaterial.cancelado_por_id",
        lazy=True,
    )
...
class DiarioBordo(db.Model):
    ...
    movimentacao_material = db.relationship(
        "MovimentacaoMaterial",
        back_populates="diario_bordo",
        cascade="all, delete-orphan",
        uselist=False,
...
class MovimentacaoMaterial(db.Model):
    ...
    foto_recebimento = db.Column(
        db.String(500),
        nullable=True,
    )

    latitude_recebimento = db.Column(
        db.Float,
        nullable=True,
    )

    longitude_recebimento = db.Column(
        db.Float,
        nullable=True,
    )

    precisao_metros = db.Column(
        db.Float,
        nullable=True,
    )

    observacao_recebimento = db.Column(
        db.Text,
        nullable=True,
    )
    ...
    client_uuid_recebimento = db.Column(
        db.String(80),
        nullable=True,
        index=True,
    )
    ...
    empresa = db.relationship(
        "Empresa",
        back_populates="movimentacoes_materiais",
    )

    diario_bordo = db.relationship(
        "DiarioBordo",
        back_populates="movimentacao_material",
    )

    recebido_por = db.relationship(
        "Usuario",
        back_populates="recebimentos_materiais",
        foreign_keys=[recebido_por_id],
    )

    cancelado_por = db.relationship(
        "Usuario",
        back_populates="cancelamentos_materiais",
